...
namespace Amilon\Api\V1\Contract;
...
/**
 * V1 contract endpoint: the configured contract's balance and last-update time.
 *
 * `GET contracts/{contractId}`, bearer-authenticated. Reached through
 * {@see \Amilon\Service\AmilonClient::getContractInfo()}.
 *
